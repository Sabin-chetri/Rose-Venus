<x-guest-layout>
    <div class="text-center mb-8">
        <h1 class="text-2xl font-[Playfair_Display] font-bold text-stone-900">Confirm Password</h1>
        <p class="mt-1.5 text-sm text-stone-400">Please confirm your password before continuing</p>
    </div>
