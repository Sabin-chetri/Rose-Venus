<x-guest-layout>
    <div class="text-center mb-8">
        <h1 class="text-2xl font-[Playfair_Display] font-bold text-stone-900">Reset Password</h1>
        <p class="mt-1.5 text-sm text-stone-400">Choose a new password for your account</p>
    </div>
